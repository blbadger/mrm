...
class MLPMixer(nn.Module):
    ...
    def _init_weights(self):
        for m in self.modules():
            ...
            or isinstance(m, DiagonalColCausalLinear) or isinstance(m, DiagonalRowCausalLinear) or isinstance(m, KernelRepeatLinear) or isinstance(m, HeadedRepeatCausalLinear):
