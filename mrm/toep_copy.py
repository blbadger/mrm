...
import shutil
from repeat_main import RepeatCausalLinear, KernelRepeatLinear
    ...
    def __init__(
        ...
        if heads and heads > 0:
            ...
            if expanded_convs:
                ...
                # flat mixer layer
                self.token_mixing_layer = KernelRepeatLinear(seq_len, 4)  # type: ignore[assignment]
...
class MLPMixer(nn.Module):
    ...
    def forward(self, input_ids, labels=None, **kwargs):
        ...
        if all_hammings and self.training: 
...
if __name__ == "__main__":
    ...
    output_dir = f"{checkpoint_root}/fineweb_copy_colrepeat_k4_{dim}_n{layers}_b16x4"
